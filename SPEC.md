...
| `DB_PATH` | `/data/bridge.db` | Required on Fly (volume `bridge_data`) |
| `PUBLIC_BASE_URL`, `CALLBACK_TTL_SECONDS`, `CALLBACK_ALLOW_HTTP`, `CALLBACK_ALLOWED_HOSTS`, `INBOUND_TIMESTAMP_TOLERANCE_SECONDS` | — | Optional |
